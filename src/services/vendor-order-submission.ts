...
import { TOrderSubmission, TPurchaseItem, TVendorParams, TCustomerUUID } from "../types/vendor-order-submission";
...
export async function getCustomerUUID(email: string): Promise<ISaleCustomerInfo>{
